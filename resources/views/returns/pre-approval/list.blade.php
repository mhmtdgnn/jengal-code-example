                    ...
                    <tr>
                        ...
                        <td>
                            <div class="badge badge-info">
                                {{ config('sebportal.magaza_durumlar.'.$item->status) }}
                            </div>
                        </td>
                        <td>
                            <small>Talep Tarihi : {{ $item->created_at->format('d.m.Y H:i') }}</small>
                        </td>
                        <td>{{ $item->adet }}</td>
                        <td>{{ $item->koli }}</td>
                        <!--begin::Action=-->
                        <td class="text-end">
                            <a href="{{ route('returns.pre_approval.detail', $item->id) }}" class="btn btn-sm btn-light-primary btn-active-light-info">İşlem</a>
                        </td>
                        <!--end::Action=-->
                    </tr>
                    @endforeach
