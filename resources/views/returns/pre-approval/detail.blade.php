            ...
            <div class="col-lg-12">
                <div class="card mb-5 mb-xl-10">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold ps-4">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active"
                                    data-bs-toggle="tab" href="#kt_tab_pane_1">İade Detayı</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0"
                                    data-bs-toggle="tab" href="#kt_tab_pane_2">Log</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
                                    ...
                                    <table id="kt_datatable_example_5" class="table table-striped gy-5 gs-7 rounded">
                                        ...
                                        <tbody>
                                            @foreach ($returnDetails as $item)
                                                <tr @if ($item->isOk == 1) class="talep_red" @else class="talep_onay" @endif
                                                    id="talep_{{ $item->product_id }}_{{ $item->return_reason_id }}">
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                            <input
                                                                onclick="urunOnay({{ $item->product_id }},'{{ $item->return_reason_id }}',{{ $item->talep_id }})"
                                                ...
                                                @php
                                                    $toplamdesi = $toplamdesi + intval($item->desi);
                                                    $say++;
                                                @endphp
                                            @endforeach
                                        </tbody>
                    ...
                    <div class="card-footer text-end">
                        <span class="btn btn-md btn-info px-10 me-3" data-bs-toggle="modal"
                            data-bs-target="#modal_onayla">Onayla</span>
                        <span class="btn btn-md btn-danger px-10 me-3" data-bs-toggle="modal"
                            data-bs-target="#modal_reddet">Reddet</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="modal_onayla_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        action="{{ route('returns.pre_approval.approve') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex flex-column mb-4 fv-row">
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                data-placeholder="Transfer Yöntemi Seçiniz" name="transfer" required>
                        ...
                        <div class="mb-13">
                            <div class="text-muted fw-semibold fs-6">
                                Talep kaydını onaylamak üzeresiniz. Bu işleme devam etmek istediğinizden emin misiniz?
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal_reddet" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="modal_reddet_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        action="{{ route('returns.pre_approval.reject') }}" method="POST">
                        @csrf
                        <div class="mb-13 text-center">
                            <h1 class="mb-3 text-gray-700">Talep Red Ediliyor</h1>
                        </div>
                        <div class="d-flex flex-column mb-5">
                            <textarea class="form-control form-control-solid" rows="4" name="note_red" placeholder="Reddedilme Notu"></textarea>
                        </div>
                        <div class="mb-13">
                            <div class="text-muted fw-semibold fs-6">
