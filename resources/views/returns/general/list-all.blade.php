                            ...
                            <div class="px-7 py-5">
                                <form action="" method="GET">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('returns.showAll') }}" class="btn btn-info btn-sm me-2">Tümünü Gör</a>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-50px">Talep Tipi</th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        @foreach ($returns as $item)
                            <tr>
                                <td>
                                    <small class="text-dark fw-bold">#{{ $item->id }}</small>
                                </td>
                                <td>
                                    <small class="text-info fw-bold">{{ $item->refundOrderNumber }}</small>
                                </td>
                                <td>
                                    <small class="badge badge-{{ ($item->tip == 1)? 'primary' : 'info' }}">{{ ($item->tip == 1)? 'İADE' : "DEĞİŞİM" }}</small>
                                </td>
                                <td>
                                    <small class="text-primary">
                                        <strong>{{ config('sebportal.magaza_durumlar.' . $item->status) }}</strong>
                                    </small>
                                </td>
                                <td>
                                    <small>
