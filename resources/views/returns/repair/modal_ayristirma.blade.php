<form 
    ...
    <div class="mb-3">
        @csrf
        <input type="hidden" id="return_detail_id" name="return_detail_id" value="{{ $response['return_detail_id'] }}">
        <input type="hidden" name="return" value="{{ $response['return_id'] }}">
        <input type="hidden" name="product_iris_kategori" id="product_iris_kategori" value="{{ $response['product']['iris_kategori'] }}">
        <div class="w-100">
                ...
                <div class="row my-8">
                    <div class="col-md-4">
                        <div class="d-flex flex-column h-100 bg-light-info p-4 border border-info rounded">
                            ...
                            <span class="mb-3" id="product_sap_code"></span>
                        </div>
                    </div>
                    <div class="col-md-8 p-4 border rounded">
                        ...
                        <div class="row" data-kt-buttons="true">
                            ...
                            <!--end::Radio button-->
                            <div class="col-md-12" style="display: block" id="ayristirma">
                                ...
                                <select class="form-select form-select-solid mb-3" id="ayristirma_id"
                                    ...
                                    <option value="4">Y5 - Hurda(H)</option>
                                </select>
                            </div>
                        </div>
                        <!--end::Radio group-->
