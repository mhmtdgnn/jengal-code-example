            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="w-200px">Yazdırılan Ürün Barkod</th>
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if(!empty($item->printed_product_barcode))
                            <button type="button" 
                                class="btn btn-icon btn-circle btn-sm btn-light-info" 
                                data-bs-toggle="popover" 
                                data-bs-placement="top" 
                                title="Gönderi Takip No" 
                                data-bs-content="{{ $item->printed_product_barcode }}">
                        ...
                        <td class="text-end">
                            <a href="#//" 
                                class="btn btn-sm btn-light-primary btn-active-light-info">
                                İşlem
                            </a>
                        </td>
                        <!--end::Action=-->
