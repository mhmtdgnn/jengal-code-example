            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td>
                            <small>Talep Tarihi : {{ $item->created_at->format('d.m.Y H:i:s') }}</small>
                        </td>
                        <td>
                            {{ $item->adet }}
                        </td>
                        <!--begin::Action=-->
                        <td class="text-end">
                            <a href="{{ route('returns.sales.detail', $item->id) }}" class="btn btn-sm btn-light-primary btn-active-light-info">İşlem</a>
                        </td>
                        <!--end::Action=-->
                    </tr>
                    @endforeach
